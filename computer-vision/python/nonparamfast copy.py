...
class segmentation(object):
    ...
    def non_parametric_segmentation(self, frame):
        ...
        back_projection = self.hmatrix1d[frame_g_int*self.bins + frame_r_int + 1].reshape(self.frame_r.shape).astype(np.uint8)
    ...
    def main_segmentation(self):
        ...
        while True:
            ...
            title = "Histogram Backprojection using Matrix Manipulation unflattened"
            cv2.namedWindow(title, cv2.WINDOW_NORMAL)
